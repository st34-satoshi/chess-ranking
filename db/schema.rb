...
ActiveRecord::Schema[7.0].define(version: 2025_01_12_055916) do
  ...
  create_table "redirects", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "ncs_id"
    t.string "public_uid", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ncs_id"], name: "index_redirects_on_ncs_id", unique: true
    t.index ["public_uid"], name: "index_redirects_on_public_uid", unique: true
  end
